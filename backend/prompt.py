def prompt_string():
    ...
    - A concise summary of the most critical findings at the top.
    ...
    - For complex findings give Affected Software, Weakness,  Severity, Potential Mitigations, Related Attack Patterns,
